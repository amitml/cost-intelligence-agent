...
```
AgentCore ARN:    arn:aws:bedrock-agentcore:us-east-1:<ACCOUNT_ID>:runtime/finops_runtime-f25c6ZCRzH
Gateway ARN:      arn:aws:bedrock-agentcore:us-east-1:<ACCOUNT_ID>:gateway/finops-gateway-c6bkzwrmeg
Memory ID:        finops_memory-wGlPmPF0v3
SNS Topic:        arn:aws:sns:us-east-1:<ACCOUNT_ID>:cost-intelligence-alerts
