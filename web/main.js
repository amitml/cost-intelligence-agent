...
const AGENT_ARN='arn:aws:bedrock-agentcore:us-east-1:<ACCOUNT_ID>:runtime/costop_runtime-thVaesENyr';
...
window.INVESTIGATIONS_TABLE='CostOp-investigations';
window.INVESTIGATIONS_TABLE='CostOp-investigations';
window.INVESTIGATIONS_TABLE='CostOp-investigations';
window.INVESTIGATIONS_TABLE='CostOp-investigations';
window.ALARM_PREFIX='CostOp';
window.INVESTIGATIONS_TABLE='CostOp-investigations';
window.ALARM_PREFIX='CostOp';
window.INVESTIGATIONS_TABLE='CostOp-investigations';
window.ALARM_PREFIX='CostOp';
