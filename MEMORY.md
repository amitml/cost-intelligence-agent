...
| Resource | Value |
|---|---|
| Runtime | arn:aws:bedrock-agentcore:us-east-1:<ACCOUNT_ID>:runtime/finops_runtime-f25c6ZCRzH |
...
| ECR Private | <ACCOUNT_ID>.dkr.ecr.us-east-1.amazonaws.com/finops-agent-runtime |
...
| SNS | arn:aws:sns:us-east-1:<ACCOUNT_ID>:cost-intelligence-alerts |
| Account | <ACCOUNT_ID> |
| Region | us-east-1 |
...
aws bedrock-agentcore-control update-agent-runtime --agent-runtime-id finops_runtime-f25c6ZCRzH \
  --agent-runtime-artifact '{"containerConfiguration":{"containerUri":"<ACCOUNT_ID>.dkr.ecr.us-east-1.amazonaws.com/finops-agent-runtime:v18-stable"}}' \
  --role-arn "arn:aws:iam::<ACCOUNT_ID>:role/FinOpsAgentRuntimeStack-RuntimeRole" \
