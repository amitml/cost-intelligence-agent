...
def send_notification(subject: str, message: str) -> str:
    ...
    try:
        ...
        topic_arn = 'arn:aws:sns:us-east-1:<ACCOUNT_ID>:cost-intelligence-alerts'
        # Get subscribers
    ...
    try:
        ...
        budgets.create_budget(
            ...
            NotificationsWithSubscribers=[{
                ...
                'Subscribers': [{'SubscriptionType': 'SNS', 'Address': 'arn:aws:sns:us-east-1:<ACCOUNT_ID>:cost-intelligence-alerts'}]
            }]
        )
